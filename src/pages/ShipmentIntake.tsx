...
import { ArrowLeft, Upload, X, FileText, Sparkles, RotateCcw, ClipboardList, ShieldCheck, FileCheck } from "lucide-react";
...
export default function ShipmentIntake() {
  ...
  // When mode selector changes, sync form transport mode and direction
  ...
  const applyPreFill = (fields: Record<string, string>) => {
    ...
    // COO auto-detection for Colombia→US
  ...
  // Count completion per tab for badges
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <h1 className="text-base font-bold">Shipments Workspace</h1>
              <Badge variant="outline" className="text-[10px] font-mono">{form.shipment_id}</Badge>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={() => setShowPreFill(true)} variant="outline" size="sm" className="text-xs gap-1.5 border-primary/30 text-primary hover:bg-primary/10">
              <Sparkles size={12} /> Smart Pre-fill
            </Button>
      ...
      <main className="container mx-auto px-4 py-5">
        ...
        {/* Main workspace: tabs + right panel */}
          ...
          <div className="lg:col-span-8">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="w-full justify-start bg-card border border-border rounded-lg p-1 h-auto flex-wrap">
                <TabsTrigger value="details" className="text-xs gap-1.5 data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
                ...
                <TabsTrigger value="documents" className="text-xs gap-1.5 data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
                  <FileText size={13} /> Documents
                  {docsComplete > 0 && <Badge variant="outline" className="text-[9px] px-1 py-0 ml-1">{docsComplete}</Badge>}
                </TabsTrigger>
                <TabsTrigger value="compliance" className="text-xs gap-1.5 data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
                  <ShieldCheck size={13} /> Compliance
                </TabsTrigger>
                <TabsTrigger value="review" className="text-xs gap-1.5 data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
                  <FileCheck size={13} /> Review & Submit
                </TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="documents" className="mt-4 space-y-5">
                ...
                <div className="flex justify-between">
                  <Button variant="outline" onClick={() => setActiveTab('details')} className="text-xs">← Back to Details</Button>
                  <Button onClick={() => setActiveTab('compliance')} className="text-xs gap-1.5">Continue to Compliance →</Button>
                </div>
              </TabsContent>
              ...
              <TabsContent value="compliance" className="mt-4 space-y-5">
                ...
                <div className="flex justify-between">
                  <Button variant="outline" onClick={() => setActiveTab('documents')} className="text-xs">← Back to Documents</Button>
                  <Button onClick={() => setActiveTab('review')} className="text-xs gap-1.5">Continue to Review →</Button>
                </div>
              </TabsContent>
